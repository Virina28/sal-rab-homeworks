function calcShipping(sum, min, shipping) {
    ...
    consol.log(shippingSum = 0)}; // то shippingSum присвоить значение 0
    ...
    consol.log(shippingSum = shippingPrice)}; // то shippingSum присвоить значение shippingPrice
...
function calcDiscount(sum, min, discount) {
    ...
    consol.log(discountSum = productsSum/100*discountPart)}; // то присвойте discountSum значение discountPart процентов от productsSum,
...
function calcInvoice({sum, discountMinSum, discountPart, shippingFreeMinSum, shippingPrice}) {
    ...
    boolean freeShipping = shippingSum == 0 = true;// если shippingSum равно нулю, то freeShipping должна быть равна true, иначе freeShipping должна быть равна false
