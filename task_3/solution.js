function renderCartItem(item) {
    ...
    item = [{id: 1, title: 'Пицца', count: 5, price: '500'}]; // product - объект вида {id: id, title: title, count: count, price: price}
    ...
    let itemCountText = " "; // 1. Создайте переменную itemCountText, равную пустой строке
        itemCountText = itemCountText + console.log(product[0].count); // 2. Присвойте переменной itemCountText результат склеивания itemCountText и количества
        itemCountText = itemCountText + ` × `; // 3. Присвойте переменной itemCountText результат склеивания itemCountText и ` × `
        itemCountText = itemCountText + console.log(product[0].price); // 4. Присвойте переменной itemCountText результат склеивания itemCountText и цены
        itemCountText = itemCountText + ` ₽ = `; // 5. Присвойте переменной itemCountText результат склеивания itemCountText и ` ₽ = `
    let sum = console.log(product[0].count) * console.log(product[0].price); // 6. Создайте переменную sum и присвойте ей значение произведения количества и цены
